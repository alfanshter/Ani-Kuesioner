         ...
         <div class="card">
             <div class="card-body">
                ...
                <h4 class="card-title">Produk</h4>
                             ...
                             <tr>
                                 ...
                                 <td class="align-middle text-center">
                                     <div class="d-flex justify-content-sm-center mt-2">
                                         ...
                                         <a href="/hapus_kuesioner/{{$item->id}}" onclick="return confirm('Apakah anda akan menghapus data ?')" class="btn btn-danger" style="margin-left: 10px">Hapus</a>
                                     </div>
                                 </td>
                             </tr>
                             ...
                             <div class="modal fade" id="editkuesioner{{$item->id}}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                 <div class="modal-dialog">
                                     <div class="modal-content">
                                         ...
                                         <form action="/edit_kuesioner" method="POST">
                                             @csrf
                 ...
                 <br>
                {{--Kepuasan Pelanggan--}}
                 <h4 class="card-title">Kepuasan Pelanggan</h4>
                 <div class="table-responsive">
                     <table class="table table-bordered" width="100%" id="dataTable" cellspacing="0">
                         <thead>
                             <tr class="table-danger">
