...
<head>
  ...
  <link href="{{asset('landingpage/img/logo.png')}}" rel="apple-touch-icon">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      {{--<h1 class="logo"><a href="index.html">Cistik Resep Eyang</a></h1>--}}
      <!-- Uncomment below if you prefer to use an image logo -->
     <a href="index.html" style="width: 100px" ><img src="{{asset('landingpage/img/logo.png')}}" alt="" class="img-fluid"></a>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Website e-CRM Cistik Resep </h1>
          <div><a href="/login" class="btn-get-started scrollto">Get Started</a></div>
        </div>
        <div class="col-xl-4 col-lg-6 order-1 order-lg-2 hero-img" data-aos="zoom-in" data-aos-delay="150">
          <img src="{{asset('landingpage/img/logo.png')}}" style="width:2000px;height:270px" class="img-fluid animated" alt="">
        </div>
      </div>
    </div>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="150">
            <img src="{{asset('landingpage/img/kentang.png')}}" class="img-fluid" alt="">
          </div>
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Website e-CRM Cistik Resep Eyang </h3><br>
            <p class="fst-italic" style="text-align: center">
              merupakan website yang digunakan untuk mengukur tingkat kepuasan pelayanan dan menjaga loyalitas pelanggan. Dengan mengakses website ini Anda dapat memberikan penilaian mengenai kepuasan Anda pada Cistik Resep Eyang. Segera berikan penilaian Anda untuk membangun loyalitas pelanggan Cistik Resep Eyang
            </p><br>
            <center>
            <a href="/login" class="read-more" style="text-align: center">Login<i class="bi bi-long-arrow-right"></i></a>
            </center>
    ...
    <div class="container">
      ...
      <div class="copyright-wrap d-md-flex py-4">
        <div class="me-md-auto text-center text-md-start">
          <div class="copyright">
            &copy; Copyright <strong><span>Cistik Resep Eyang</span></strong>. All Rights Reserved
          </div>
          <div class="credits">
